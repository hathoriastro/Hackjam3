...
class PreviewPageSave extends StatefulWidget {
  final List<Map<String, dynamic>> items;
  const PreviewPageSave({super.key, required this.items});

  @override
  State<PreviewPageSave> createState() => _PreviewPageSaveState();
}

class _PreviewPageSaveState extends State<PreviewPageSave> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Preview Nota anjoy")),
